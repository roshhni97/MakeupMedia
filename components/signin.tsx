...
export default function SignInPage() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-pink-100 to-violet-200 overflow-hidden">
      <div className="absolute inset-0 bg-[url('/lipstick-bg.png')] opacity-10 animate-float"></div>
      ...
      <div className="container relative z-10 flex-col items-center justify-center grid lg:max-w-none lg:grid-cols-2 lg:px-0">
        <div className="relative hidden h-full flex-col bg-muted p-10 text-white lg:flex dark:border-r overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-pink-500 to-violet-600">
            <div className="absolute inset-0 bg-gradient-to-br from-pink-500 to-violet-600 animate-gradient-y"></div>
          </div>
          ...
          <div className="relative z-20 mt-auto">
            <blockquote className="space-y-2">
              <p className="text-lg">
                &ldquo;MakeupMedia has become my daily source of inspiration.
                It's amazing to see how creative our community can be!&rdquo;
              </p>
              <footer className="text-sm">Emily Johnson</footer>
            </blockquote>
          </div>
          <div className="absolute bottom-0 left-0 right-0 h-1/3 bg-gradient-to-t from-violet-600/50 to-transparent animate-shimmer"></div>
        </div>
